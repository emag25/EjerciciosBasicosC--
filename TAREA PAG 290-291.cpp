...
/* Estructuras-1. El programa muestra la manera en que se declara una estructura,
 así como la ?forma en que se tiene acceso a los campos de las variables de tipo estructura 
...
{ 
	...
	float promedio; 
	char direccion[20];    };      /* Observa que la declaración de una estructura termina con punto y coma. */
