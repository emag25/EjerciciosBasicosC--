...
#include <stdio.h>     //   **** Faltaba incluir libreria STDIO.H *****
#include <conio.h>    
#include <string.h>
#include <clocale>
...
main()  //   ****** No se puede declarar el main como void *****
{
	...
	a3 = &a0; 
	/* En este caso al apuntador de tipo estructura alumno a3 se le asigna la dirección de la variable 
	de tipo estructura alumno, a0. */

	a4 = new (struct alumno);	 // NEW sirve para reservar memoria dinámica.
	/* Nota que al apuntador a4 es necesario asignarle una dirección de memoria. 
	Para tener acceso a los campos de un apuntador de tipo estructura, utiliza uno de los dos formatos sgts:
		apuntador->campo
	o bien
		(*apuntador).campo                    */
...
void Lectura(struct alumno *a)    /* Esta función permite leer los campos de un apuntador de tipo 
                                     estructura alumno. */
{
...
/* ERRORES
   ...
   * Faltaba incluir libreria STDIO.H
   * VOID de mas
   * Faltaba GETCH() y RETURN 0
